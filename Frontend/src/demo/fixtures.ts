...
export const TESTARCHIVE_ZIP_ID = "55555555-5555-4555-8555-555555555555";
export const ARCHIVE_PDF_ID = "eeeeeeee-eeee-4eee-8eee-eeeeeeeeeeea";
export const ARCHIVE_TEXT_01_ID = "eeeeeeee-eeee-4eee-8eee-eeeeeeeeeeeb";
export const ARCHIVE_TEXT_02_ID = "eeeeeeee-eeee-4eee-8eee-eeeeeeeeeeec";
    ...
    return [
        {
            ...
            path: "/Research/Security/2025/Q1/John Smith - Network Security.txt",
            extension: ".txt",
            mimeType: "text/plain",
            size: 377,
            uploadedAt: now,
        ...
        },
        {
            ...
            secrets: [],
            source: "imap",
            messageFrom: "Mikel Lindsaar <test@lindsaar.net>",
            messageTo: "test@test.lindsaar.net",
            dcTitle: "Testing 123",
            dcSubject: "Testing 123",
            isSpam: true,
        ...
        },
        {
            ...
            secrets: [],
            source: "api-upload",
            messageFrom: "Demo Sender <sender@example.com>",
            messageTo: "recipient@example.com",
            messageCc: "cc-recipient@example.com",
            dcTitle: "PDF attachment example",
            dcSubject: "PDF attachment example",
        ...
        },
        {
            ...
            secrets: [],
            source: "api-upload",
            dcTitle: "Sample Document",
            dcDescription:
                "A sample Word document demonstrating accessible document structure.",
            dcSubject: "Accessibility",
            featured: true,
            translations: [],
            archiveIds: [],
        ...
        },
        {
            ...
            source: "crawlerX",
            attachments: [
                { id: ARCHIVE_PDF_ID, name: "home.pdf" },
                { id: ARCHIVE_TEXT_01_ID, name: "testfile01.txt" },
                { id: ARCHIVE_TEXT_02_ID, name: "testfile02.txt" },
            ],
            translations: [],
            archiveIds: [],
        ...
        },
        {
            id: ARCHIVE_PDF_ID,
            name: "home.pdf",
            path: "/Crawler/Imports/testarchive_larger.zip/morestuff/home.pdf",
            extension: ".pdf",
            mimeType: "application/pdf",
            size: 1_737,
            uploadedAt: "2023-07-11T10:49:00Z",
            createdAt: "2023-07-11T10:09:00Z",
            modifiedAt: "2023-07-11T10:09:00Z",
            state: "processed",
            tags: ["archive", "crawler"],
            content: "A one-page PDF generated with Matplotlib.",
            summary:
                "A renderable PDF extracted from the nested archive folder.",
            flagged: false,
            hidden: false,
            seen: false,
            language: "en",
        ...
        {
            id: ARCHIVE_TEXT_01_ID,
            name: "testfile01.txt",
            path: "/Crawler/Imports/testarchive_larger.zip/testarchive/testfile01.txt",
            extension: ".txt",
            mimeType: "text/plain",
            size: 52,
            uploadedAt: "2023-07-11T10:49:00Z",
            createdAt: "2022-09-27T14:22:00Z",
            modifiedAt: "2022-09-27T14:22:00Z",
            state: "processed",
            tags: ["archive", "crawler"],
            content: "this file is for testing purposes - leave me alone!",
            summary: "A short plain-text member of the nested archive.",
            flagged: false,
            hidden: false,
            seen: false,
            language: "en",
            ...
            translations: [],
            archiveIds: [],
            data: "this file is for testing purposes - leave me alone!",
        },
        {
            id: ARCHIVE_TEXT_02_ID,
            name: "testfile02.txt",
            path: "/Crawler/Imports/testarchive_larger.zip/testarchive/testfile02.txt",
            extension: ".txt",
            mimeType: "text/plain",
            size: 18,
            uploadedAt: "2023-07-11T10:49:00Z",
            ...
            summary: "A second plain-text member of the nested archive.",
            flagged: false,
            hidden: false,
            seen: false,
            language: "en",
        ...
        },
        {
            ...
            name: "text_de.txt",
            path: "/Documents/Translations/2025/Inbound/text_de.txt",
            extension: ".txt",
            mimeType: "text/plain",
            size: 233,
        ...
        },
        {
            ...
            name: "no_tag.txt",
            path: "/News/Samples/Feeds/2025/no_tag.txt",
            extension: ".txt",
            mimeType: "text/plain",
            size: 1_149,
