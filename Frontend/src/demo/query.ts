...
const valuesByField = (document: DemoDocument): Record<string, string[]> => {
    ...
    return {
        ...
        content_truncated: [String(document.contentTruncated ?? false)],
        attachments_skipped: [String(document.attachmentsSkipped ?? false)],
        is_spam: [String(document.isSpam ?? false)],
