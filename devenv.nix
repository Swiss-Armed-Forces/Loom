  ...
  enterShell = ''
    init(){
      (
        ...
        # Ignore local changes to values-overwrites.yaml and values-up-flags.yaml.
        # These files are meant for local development overrides / generated by up.sh
        # and should not be committed. Each developer can customize them without
