...
def test_caching():
    ...
    assert caching_results.mem_size_total == 3672
    assert caching_results.entries_count_total == 7
    assert caching_results.hits_count_total == 0
    assert caching_results.miss_count_total == 7
    ...
    assert caching_results.mem_size_total == 3672
    assert caching_results.entries_count_total == 7
    assert caching_results.hits_count_total == 7  # more hits!
    assert caching_results.miss_count_total == 7
