...
def test_caching():
    ...
    assert caching_results_1.mem_size_total == 14528
    ...
    assert caching_results_2.mem_size_total == 17752
    assert caching_results_2.entries_count_total == 21
    assert caching_results_2.hits_count_total == 69  # more hits (nice)!
    assert caching_results_2.miss_count_total == 21
