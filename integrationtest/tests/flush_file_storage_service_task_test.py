...
def test_orphaned_object_is_removed():
    """An orphaned file storage object (not referenced by any repository) is deleted."""
...
def test_referenced_object_is_preserved():
...
def test_flush_task_removes_orphaned_object():
...
def test_flush_task_respects_min_age():
    """flush_file_storage_service_task does not remove objects younger than min_age."""
    file_storage = get_file_storage_service()
