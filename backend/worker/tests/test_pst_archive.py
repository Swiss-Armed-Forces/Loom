...
from worker.index_file.processor.extractor.archive_extractors import PstArchiveExtractor

TEST_ASSETS_DIR = Path(__file__).parent / "assets"


def test_pst_archive_extraction_files():
    test_asset = TEST_ASSETS_DIR / "testarchive.pst"

    processor = PstArchiveExtractor()
...
def test_pst_archive_extraction_unsupported():
